...
public record ProviderKeySummary(String provider, String label, String keyPreview, LocalDateTime registeredAt) {

    public static ProviderKeySummary from(ProviderCredential c) {
        return new ProviderKeySummary(c.getProvider(), c.getLabel(), c.getKeyPreview(), c.getCreatedAt());
    }
}
